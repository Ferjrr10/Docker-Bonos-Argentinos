...
try:
    ...
    send_df = AL29D_Precio_Fecha.to_sql(name=tablePsql, con=con, if_exists="append")
    send_df_1= AL30D_Precio_Fecha.to_sql(name=tablePsql1, con=con, if_exists="append")
    send_df_2= AL30_Precio_Fecha.to_sql(name=tablePsql12, con=con, if_exists="append")
    send_df_3= AL41D_Precio_Fecha.to_sql(name=tablePsql3, con=con, if_exists="append")
    send_df_4= AE38D_Precio_Fecha.to_sql(name=tablePsql4, con=con, if_exists="append")
    send_df_5= AL29_Precio_Fecha.to_sql(name=tablePsql5, con=con, if_exists="append")
    send_df_6= AL41_Precio_Fecha.to_sql(name=tablePsql6, con=con, if_exists="append")
    send_df_7= AE38_Precio_Fecha.to_sql(name=tablePsql7, con=con, if_exists="append")
    send_df_8= GD30D_Precio_Fecha.to_sql(name=tablePsql8, con=con, if_exists="append")
